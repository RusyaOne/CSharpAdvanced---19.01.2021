...
namespace Serialization.Examples
{
    public static class SaveToFile
    {
        public static void SaveJsonToFile()
        {
            ...
            using (FileStream stream = new FileStream(@"D:\Courses\CSharpAdvanced - 19.01.2021\10.Serialization\Serialization\Human.txt", FileMode.OpenOrCreate))
            {
        ...
        public static async void GetFromFile()
        {
            ...
            using (FileStream stream = new FileStream(@"D:\Courses\CSharpAdvanced - 19.01.2021\10.Serialization\Serialization\Human.txt", FileMode.Open))
            {
